...
export function PricingDisclaimer() {
  return (
    <p className="mx-auto max-w-2xl text-center text-xs font-light leading-relaxed text-gray-400">
      Los precios mostrados incluyen <strong className="font-medium text-gray-500">50% OFF</strong>{" "}
      válido los <strong className="font-medium text-gray-500">primeros 6 meses</strong> desde el
